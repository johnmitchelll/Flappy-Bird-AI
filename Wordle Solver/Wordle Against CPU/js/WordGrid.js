            ...
            if(this.grid[i][this.currentIndex.y].color == 'rgb(0, 173, 0)' || 
               this.grid[i][this.currentIndex.y].color == 'rgb(184, 184, 0)'){
                ...
                for (var j = 0; j < this.lettersOccurence.length; j++) {
                    if(equalIgnoreCase(this.lettersOccurence[j].letter, this.grid[i][this.currentIndex.y].letter.letter)){
                ...
                if(found == false){
                    this.lettersOccurence.push({letter: this.grid[i][this.currentIndex.y].letter.letter, count: 0});
                }
            }
        }
