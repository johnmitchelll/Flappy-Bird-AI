...
function drawTangentLine(){
    ...
    colorCircle(mouseX-linearDomain.length/2, (linearDomain[0] / zoom) * canvas.height + offY * canvas.height/zoom, 7, 'white');
    colorCircle(mouseX+linearDomain.length/2, (linearDomain[linearDomain.length-1] / zoom) * canvas.height + offY * canvas.height/zoom, 7, 'white');
